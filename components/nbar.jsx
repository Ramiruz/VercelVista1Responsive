    ...
    <div >
      <nav className="mx-auto flex w-screen items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-24 ">
          <a href="/mix_polymers" className="text-sm font-semibold leading-6 text-white">
            Mix Polymers
          </a>
          <a href="/search_polymers" className="text-sm font-semibold leading-6 text-white">
            Seach For Polymers
          </a>
          <a href="/find_polymers" className="text-sm font-semibold leading-6 text-white">
            Find Polymers
          </a>
        </Popover.Group>
      </nav>
